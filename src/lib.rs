...
fn medusa_string_to_float(context: &mut CompilerContext) {
    let quotient_loop_index = context.label_index;
    context.label_index += 1;

    let quotient_loop_break_index = context.label_index;
    context.label_index += 1;

    let quotient_loop_not_break_index = context.label_index;
    context.label_index += 1;

    let fraction_loop_index = context.label_index;
    context.label_index += 1;

    let division_loop_index = context.label_index;
    context.label_index += 1;
